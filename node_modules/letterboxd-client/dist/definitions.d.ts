export interface AbstractActivity {
     ...
     */
    type: DiaryEntryActivity | FilmLikeActivity | FilmRatingActivity | FilmWatchActivity | FollowActivity | InvitationAcceptedActivity | ListActivity | ListCommentActivity | ListLikeActivity | RegistrationActivity | ReviewActivity | ReviewCommentActivity | ReviewLikeActivity | StoryActivity | WatchlistActivity;
    /**
...
export interface AbstractSearchItem {
     ...
     */
    type: ContributorSearchItem | FilmSearchItem | ListSearchItem | MemberSearchItem | ReviewSearchItem | TagSearchItem | StorySearchItem | ArticleSearchItem | PodcastSearchItem;
    /**
...
export interface CommentUpdateMessage {
     ...
     */
    code: 'MissingComment' | 'CommentOnContentYouBlocked' | 'CommentOnBlockedContent' | 'CommentBan' | 'CommentEditWindowExpired' | 'CommentTooLong';
    /**
...
export interface Link {
     ...
     */
    type: 'letterboxd' | 'tmdb' | 'imdb' | 'gwi' | 'justwatch' | 'facebook' | 'instagram' | 'twitter' | 'youtube' | 'ticket';
    /**
...
export interface ListCreateMessage {
     ...
     * The error message code.
     */
    code: 'ListNameIsBlank' | 'UnknownFilmCode' | 'InvalidRatingValue' | 'DuplicateRank' | 'EmptyPublicList' | 'CloneSourceNotFound' | 'SharingServiceNotAuthorized' | 'CannotSharePrivateList' | 'ListDescriptionIsTooLong' | 'ListEntryNotesTooLong';
    /**
     * The error message text in human-readable form.
     */
    title: string;
...
export interface ListRelationship {
     ...
     */
    commentThreadState: 'Banned' | 'Blocked' | 'BlockedThem' | 'CanComment' | 'Closed' | 'FriendsOnly' | 'Moderated' | 'NotCommentable' | 'NotValidated';
}
export interface ListRelationshipUpdateMessage {
     ...
     * The error message code.
     */
    code: 'LikeBlockedContent' | 'LikeOwnList' | 'LikeRateLimit' | 'SubscribeWhenOptedOut' | 'SubscribeToContentYouBlocked' | 'SubscribeToBlockedContent';
    /**
     * The error message text in human-readable form.
     */
    title: string;
...
export interface ListUpdateEntry {
     ...
     */
    action?: 'ADD' | 'DELETE' | 'UPDATE' | 'SORT_NAME' | 'SORT_RELEASE_NEWEST' | 'SORT_RELEASE_OLDEST' | 'SORT_RATING_HIGHEST' | 'SORT_RATING_LOWEST' | 'SORT_AVR_RATING_HIGHEST' | 'SORT_AVR_RATING_LOWEST';
    /**
...
export interface ListUpdateMessage {
     ...
     * The error message code.
     */
    code: 'ListNameIsBlank' | 'UnknownFilmCode' | 'InvalidRatingValue' | 'DuplicateRank' | 'EmptyPublicList' | 'SharingServiceNotAuthorized' | 'CannotSharePrivateList' | 'ListDescriptionIsTooLong' | 'ListEntryNotesTooLong';
    /**
     * The error message text in human-readable form.
     */
    title: string;
...
export interface LogEntryUpdateMessage {
     ...
     * The error message code.
     */
    code: 'InvalidRatingValue' | 'InvalidDiaryDate' | 'ReviewWithNoText' | 'ReviewIsTooLong' | 'LogEntryWithNoReviewOrDiaryDetails';
    /**
     * The error message text in human-readable form.
     */
    title: string;
...
export interface Member {
     ...
     */
    orgType: 'Society' | 'Educator' | 'Exhibitor' | 'Festival' | 'Single_Film' | 'Genre' | 'Association' | 'Media_Publisher' | 'Product_Platform' | 'Podcast' | 'Streamer' | 'Studio';
    /**
...
export interface MemberSettingsUpdateMessage {
     ...
     * The error message code.
     */
    code: 'IncorrectCurrentPassword' | 'BlankPassword' | 'InvalidPassword' | 'InvalidEmailAddress' | 'EmailAddressInUse' | 'InvalidFavoriteFilm' | 'BioTooLong' | 'InvalidPronounOption';
    /**
     * The error message text in human-readable form.
     */
    title: string;
...
export interface ReportMemberRequest {
     ...
     */
    reason: 'AbusiveAccount' | 'HatefulAccount' | 'ManipulativeAccount' | 'OffensiveAccount' | 'ParodyAccount' | 'PiracyAccount' | 'PlagiaristAccount' | 'SolicitousAccount' | 'SpamAccount' | 'Other';
    /**
...
export interface ReviewRelationshipUpdateMessage {
     ...
     * The error message code.
     */
    code: 'LikeBlockedContent' | 'LikeOwnReview' | 'LikeRateLimit' | 'LikeRemovedReview' | 'LikeLogEntryWithoutReview' | 'SubscribeWhenOptedOut' | 'SubscribeToContentYouBlocked' | 'SubscribeToBlockedContent';
    /**
     * The error message text in human-readable form.
     */
    title: string;
